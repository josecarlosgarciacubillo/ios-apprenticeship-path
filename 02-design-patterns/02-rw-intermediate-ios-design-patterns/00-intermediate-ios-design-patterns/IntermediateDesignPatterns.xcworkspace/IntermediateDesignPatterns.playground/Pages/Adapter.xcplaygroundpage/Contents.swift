...
public class GoogleAuthenticator {
  ...
  public func login(email: String, password: String, completion: (GoogleUser?,  Error?) -> Void) {
    // Make networking calls, wich return a special "token"
...
authService.login(email: "dev@life.com", password: "password") { (user, token) in
